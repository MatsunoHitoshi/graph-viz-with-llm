...
//     <div
//       className={clsx(
//         `absolute flex max-h-[500px] flex-row items-start gap-2 overflow-y-scroll rounded-[10px] bg-black/20 p-4 backdrop-blur-sm ${isPanelOpen ? "right-3 w-[400px] pr-14" : "right-6 w-0 pr-12"}`,
//       )}
//     >
//       <Button
//         onClick={() => {
